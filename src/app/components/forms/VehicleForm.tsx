...
interface VehicleFormProps {
  ...
  onSubmit: (values: { licensePlate: string; tireSize: string; wheelCount: number; vehicleType: VehicleType }) => void;
}
...
const VehicleForm: React.FC<VehicleFormProps> = ({ tireData, onSubmit }) => {
    const initialValues = {
        licensePlate: "",
        tireSize: "",
        vehicleType: VehicleType.SMALL_CAR, // Використовуємо значення enum
        wheelCount: 4,
      };
